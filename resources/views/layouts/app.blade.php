...
<head>
    ...
    <title>Olshop Mebel | {{ $title }}</title>
...
<body>
    <div class="m-6">
        <h1 class="text-4xl text-yellow-400">Sample Model</h1>
        ...
        <div id="radioButtons_papan">
        </div>
        <br>
        <h3 class="text-2xl">Custom Kaki</h3>
        <div id="radioButtons_kaki">
        </div>
        ...
        <button id="applyButton" onclick="applyChanges()" type="button"
            class="inline-flex items-center justify-center gap-2 rounded-md border border-transparent bg-blue-500 py-2 px-3 text-sm font-semibold text-white transition-all hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
            Apply
        </button>
    </div>
    ...
    <script>
        const items_papan = [{
                value: "item1",
                label: "Papan Persegi Panjang",
                url: "PapanPanjang.x3d",
            },
            {
                value: "item2",
                label: "Papan Bulat",
        ...
        const items_kaki = [{
                value: "item1",
                label: "Kaki Meja Panjang",
                url: "KakiMejaPanjangKayu.x3d",
            },
            {
                value: "item2",
                label: "Kaki Meja Bulat",
                url: "KakiBulat.x3d",
            },
            {
                value: "item3",
                label: "Kaki Meja Segienam",
                url: "Kaki1.x3d",
            },
            // Add more items as needed
        ];
        ...
        document.getElementById("x3dContent").innerHTML = `<inline mapDEFToID="true" url="${currentState_papan}"></inline>
        ...
        async function applyChanges() {
            ...
            document.getElementById("x3dContent").innerHTML = `<inline mapDEFToID="true" url="${newPapan.url}"></inline>
