                ...
                <div class="-mx-3">
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="name" id="" placeholder="Ex: Banana"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="number" name="price" id="" placeholder="Only number (Ex.12000)"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white px-6 py-3 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                    </div>
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="number" name="qty" id="" placeholder="Input your quantity"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white px-6 py-3 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="flex items-center">
                            <input type="radio" name="status" value="1" id="radioButton1" class="h-5 w-5" />
                            <label for="radioButton1" class="pl-3 text-base font-medium text-[#07074D]">
                                True
                            </label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="status" value="0" id="radioButton2" class="h-5 w-5" />
